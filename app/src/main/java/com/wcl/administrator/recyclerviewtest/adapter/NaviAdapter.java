...
public class NaviAdapter extends RecyclerView.Adapter<NaviAdapter.MyViewHolder> {
    ...
    public NaviAdapter(Context mContent, List<NaviBean.DataBean> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContent).inflate(R.layout.item_navi, null, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, final int i) {
        myViewHolder.tvProject.setText(mData.get(i).getName());
      myViewHolder.tvProject.setBackgroundResource(mData.get(i).getChecked() ?
